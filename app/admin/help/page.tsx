...
const helpSections = [
  ...
  },
  {
    ...
    items: [
      ...
      "Challenge overrides are limited to eight approved models, including lightweight Llama, Qwen, and Phi options; custom model IDs are not accepted.",
      "Gemma was removed from the approved list because it was unreliable in this setup.",
